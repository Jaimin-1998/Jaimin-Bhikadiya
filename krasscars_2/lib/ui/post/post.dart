          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  AppString.strProductDescription,
                  style: TextStyle(
                      color: AppThemes.clrBlack,
                      fontFamily: AppFonts.PoppinsBold,
                      fontSize: AppFonts.size_medium),
              ...
              detailRowWidget('Manufacturers', 'BMW'),
              detailRowWidget('Model', 'BMW X3 four'),
              detailRowWidget('Build Type', 'Mini Truck'),
              detailRowWidget('Transmission', 'Automatic'),
              detailRowWidget('Fuel Type', 'Petrol'),
            ],
          ),
        ),
      ),
